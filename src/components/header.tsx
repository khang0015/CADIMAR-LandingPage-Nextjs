...
import LanguageSelector from "@/components/language-selector-simple";
          ...
          <Link href="/">
            ...
            >
              ...
              <div className="flex flex-col">
                <span className="text-xl font-bold bg-gradient-to-r from-gray-900 via-gray-700 to-brand-green bg-clip-text text-transparent">
                  {t("brand.name")}
                </span>
                <motion.div 
